...
const navItems = [
  ...
  { id: "feed", label: "Feed", icon: Feed, href: "#", disabled: true },
  { id: "careers", label: "Careers", icon: Careers, href: "#", disabled: true },
  { id: "schools", label: "Schools", icon: School, href: "#", disabled: true },
  { id: "application-manager", label: "App Manager", icon: Applications, href: "#", disabled: true },
  { id: "financing", label: "Financing", icon: DollarSign, href: "#", disabled: true },
  { id: "transition", label: "Transition", icon: FlagBannerFold, href: "#", disabled: true },
  { id: "messages", label: "Messages", icon: ChatCircle, href: "/messages", disabled: false },
];
...
export default function Sidebar({ collapsed = false }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      >
        {collapsed ? <WillowMark /> : <WillowLogo />}
      </Box>
            ...
            >
              <Box
                ...
                sx={{
                  ...
                  color: isDisabled ? "#9CA3AF" : isActive ? "#334155" : "#374151",
                  fontSize: "14px",
                  textDecoration: "none",
                  ...
                  ...(!isDisabled && {
                    "&:hover": {
                      bgcolor: isActive ? "#E5E7EB" : "rgba(0,0,0,0.04)",
                    },
                  }),
                }}
              >
                <Box sx={{ flexShrink: 0, display: "flex", alignItems: "center" }}>
                  <IconComponent
                    size={20}
                    color={isDisabled ? "#9CA3AF" : isActive ? "#334155" : "#6B7280"}
                  />
                </Box>
                <Box
                  component="span"
      ...
      <Box sx={{ mt: "auto", pl: 1.5, pr: 1, py: 1.5, overflow: "hidden" }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
          ...
          <Box sx={{ flexShrink: 0, opacity: collapsed ? 0 : 1, transition: "opacity 0.2s ease" }}>
            <IconButton variant="ghost" size="sm">
              <OptionsVertical size={18} />
            </IconButton>
          </Box>
        </Box>
      </Box>
