...
import { neutral, Slate, red, blue, yellow, successGreen, lavender, essentials, hexToRgba } from "../tokens/primitives.js";
...
const themeOptions = {
  ...
  components: {
    ...
    WillowButton: {
      styleOverrides: {
        root: ({ ownerState, theme }: { ownerState: Record<string, unknown>; theme: unknown }) => {
