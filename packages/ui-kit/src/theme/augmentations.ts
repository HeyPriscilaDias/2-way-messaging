...
declare module "@mui/material/styles" {
  ...
  // Extend the Palette interface for runtime access to custom colors
  interface Palette {
...
// Button variant overrides for WillowButton
declare module "@mui/material/Button" {
  interface ButtonPropsVariantOverrides {
    ...
    "text-dark": true;
    "text-light": true;
    // Keep standard MUI variants enabled for compatibility
    contained: true;
    outlined: true;
    text: true;
  }
