...
const SvgStudent = React.forwardRef<SVGSVGElement, SVGProps>(({
  size = 24,
  color = 'currentColor',
  ...props
}, ref) => React.cloneElement(<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 6v7.5M3 6l9 3 9-3-9-3zm2.25 14.25C6.722 17.992 9.104 16.5 12 16.5m0 0c2.896 0 5.278 1.492 6.75 3.75M12 16.5a5.25 5.25 0 0 0 3.876-8.792M12 16.5a5.25 5.25 0 0 1-3.876-8.792" /></svg>, {
  ...props,
  ref,
  width: size,
  height: size,
